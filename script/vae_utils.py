...
class VAEUtils(object):
    def __init__(self,
        ...
        # load parameters
        self.params = hyperparameters.load_params()
        ...
        # char stuff
        chars = json.load(open(self.params["dict_path"]))
        self.chars = chars
        self.params['NCHARS'] = len(chars)
        self.char_indices = chars
        self.indices_char = dict((chars[i], i) for i in chars)
        # encoder, decoder
    ...
    #
    #     p = self.params
    #     selfs = [selfies.encoder(s) for s in smiles]
    #     z = mu.selfies_to_hot(selfs,
    #                          p['MAX_LEN'],
    #                          p['PADDING'],
    #                          self.char_indices,
    #                          p['NCHARS'])
